    ...
    namespace game {
        namespace mmsdk {
            ...
            enum API_EVENT_LIST {
                ...
                enableMicCallback = "enableMicCallback",
                ...
                onSpeakersDetectionExCallback = "onSpeakersDetectionExCallback",
                ...
                onPlayerOnlineCallback = "onPlayerOnlineCallback",
                onPlayerOfflineCallback = "onPlayerOfflineCallback",
                onForbiddenByOwnerCallback = "onForbiddenByOwnerCallback",
                onRecvMsgCallback = "onRecvMsgCallback",
                onRemoteMicroStateChangedCallback = "onRemoteMicroStateChangedCallback",
                initSpatialSoundCallback = "initSpatialSoundCallback",
                setAudioRecvRangeCallback = "setAudioRecvRangeCallback",
                updateSelfPositionCallback = "updateSelfPositionCallback",
                updateRemotePositionCallback = "updateRemotePositionCallback",
                clearRemotePlayerPositionCallback = "clearRemotePlayerPositionCallback",
                clearAllRemotePositionsCallback = "clearAllRemotePositionsCallback",
                isEnableSpatialSoundCallback = "isEnableSpatialSoundCallback",
                onJoinRangeRoomCallback = "onJoinRangeRoomCallback",
                enableSpatialSoundCallback = "enableSpatialSoundCallback"
            }
            /**
             * @en
            ...
            class MmSdkService {
                ...
                */
                ...
                private _onPlayerOnlineCallback;
                /**
                ...
                private _onPlayerOfflineCallback;
                /**
                 * 设置麦克风状态
                ...
                private _onForbiddenByOwnerCallback;
                /**
                 * 禁言/解禁其他全部玩家
                 * https://developer.huawei.com/consumer/cn/doc/development/AppGallery-connect-Guides/gamemme-forbidplayer-android-0000001242285225
                 *
                ...
                private _onSpeakersDetectionExCallback;
                /**
                ...
                private _initSpatialSoundCallback;
                /**
                 ...
                 *
                 * @param roomId：房间ID;
                 * @param enable：是否开启3D音效,true表示开启,false表示关闭
                 */
                enableSpatialSound(roomId: string, enable: boolean): void;
                private _enableSpatialSoundCallback;
                /**
                 * 设置语音接收范围
                ...
                private _setAudioRecvRangeCallback;
                /**
                ...
                private _updateSelfPositionCallback;
                /**
                ...
                private _updateRemotePositionCallback;
                /**
                ...
                private _clearRemotePlayerPositionCallback;
                /**
                ...
                private _clearAllRemotePositionsCallback;
                /**
                ...
                private _isEnableSpatialSoundCallback;
                /**
                 * 加入范围语音房间
                ...
                private _onJoinRangeRoomCallback;
                /**
                 * 加入临时群组
